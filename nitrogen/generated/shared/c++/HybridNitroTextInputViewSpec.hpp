...
namespace margelo::nitro::nitrotextinput {
  ...
  class HybridNitroTextInputViewSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual std::optional<bool> getEnableReturnKeyAutomatically() = 0;
      virtual void setEnableReturnKeyAutomatically(std::optional<bool> enableReturnKeyAutomatically) = 0;
