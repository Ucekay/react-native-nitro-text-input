...
namespace margelo::nitro::nitrotextinput {
  ...
  /**
   * An abstract base class for `NitroMultiLineTextInputView`
   * Inherit this class to create instances of `HybridNitroMultiLineTextInputViewSpec` in C++.
   * You must explicitly call `HybridObject`'s constructor yourself, because it is virtual.
   * @example
   * ```cpp
   * class HybridNitroMultiLineTextInputView: public HybridNitroMultiLineTextInputViewSpec {
   * public:
   *   HybridNitroMultiLineTextInputView(...): HybridObject(TAG) { ... }
   *   // ...
   * };
   * ```
   */
  class HybridNitroMultiLineTextInputViewSpec: public virtual HybridObject {
    public:
      // Constructor
      explicit HybridNitroMultiLineTextInputViewSpec(): HybridObject(TAG) { }

      // Destructor
      ~HybridNitroMultiLineTextInputViewSpec() override = default;
    ...
    public:
      ...
      virtual std::optional<std::function<void(double /* width */, double /* height */)>> getOnContentSizeChanged() = 0;
      virtual void setOnContentSizeChanged(const std::optional<std::function<void(double /* width */, double /* height */)>>& onContentSizeChanged) = 0;
    ...
    protected:
      // Tag for logging
      static constexpr auto TAG = "NitroMultiLineTextInputView";
  };
