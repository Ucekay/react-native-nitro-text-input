///
/// HybridNitroMultiLineTextInputViewSpecSwift.hpp
...
namespace margelo::nitro::nitrotextinput {
  ...
  /**
   * The C++ part of HybridNitroMultiLineTextInputViewSpec_cxx.swift.
   *
   * HybridNitroMultiLineTextInputViewSpecSwift (C++) accesses HybridNitroMultiLineTextInputViewSpec_cxx (Swift), and might
   * contain some additional bridging code for C++ <> Swift interop.
   *
   * Since this obviously introduces an overhead, I hope at some point in
   * the future, HybridNitroMultiLineTextInputViewSpec_cxx can directly inherit from the C++ class HybridNitroMultiLineTextInputViewSpec
   * to simplify the whole structure and memory management.
   */
  class HybridNitroMultiLineTextInputViewSpecSwift: public virtual HybridNitroMultiLineTextInputViewSpec {
  public:
    // Constructor from a Swift instance
    explicit HybridNitroMultiLineTextInputViewSpecSwift(const NitroTextInput::HybridNitroMultiLineTextInputViewSpec_cxx& swiftPart):
      HybridObject(HybridNitroMultiLineTextInputViewSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline NitroTextInput::HybridNitroMultiLineTextInputViewSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  public:
    ...
    inline std::optional<std::function<void(double /* width */, double /* height */)>> getOnContentSizeChanged() noexcept override {
      auto __result = _swiftPart.getOnContentSizeChanged();
      return __result;
    }
    inline void setOnContentSizeChanged(const std::optional<std::function<void(double /* width */, double /* height */)>>& onContentSizeChanged) noexcept override {
      _swiftPart.setOnContentSizeChanged(onContentSizeChanged);
    }
  ...
  private:
    NitroTextInput::HybridNitroMultiLineTextInputViewSpec_cxx _swiftPart;
  };
