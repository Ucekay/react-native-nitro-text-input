///
/// HybridNitroMultiLineTextInputViewComponent.mm
/// This file was generated by nitrogen. DO NOT MODIFY THIS FILE.
/// https://github.com/mrousavy/nitro
/// Copyright © 2025 Marc Rousavy @ Margelo
///

#import "HybridNitroMultiLineTextInputViewComponent.hpp"
#import <memory>
...
#import "HybridNitroMultiLineTextInputViewSpecSwift.hpp"
...
/**
 * Represents the React Native View holder for the Nitro "NitroMultiLineTextInputView" HybridView.
 */
@interface HybridNitroMultiLineTextInputViewComponent: RCTViewComponentView
@end

@implementation HybridNitroMultiLineTextInputViewComponent {
  std::shared_ptr<HybridNitroMultiLineTextInputViewSpecSwift> _hybridView;
}

+ (void) load {
  [super load];
  [RCTComponentViewFactory.currentComponentViewFactory registerComponentViewClass:[HybridNitroMultiLineTextInputViewComponent class]];
}

+ (react::ComponentDescriptorProvider) componentDescriptorProvider {
  return react::concreteComponentDescriptorProvider<HybridNitroMultiLineTextInputViewComponentDescriptor>();
}

- (instancetype) init {
  if (self = [super init]) {
    std::shared_ptr<HybridNitroMultiLineTextInputViewSpec> hybridView = NitroTextInput::NitroTextInputAutolinking::createNitroMultiLineTextInputView();
    _hybridView = std::dynamic_pointer_cast<HybridNitroMultiLineTextInputViewSpecSwift>(hybridView);
    [self updateView];
  }
  return self;
}
...
- (void) updateView {
  // 1. Get Swift part
  NitroTextInput::HybridNitroMultiLineTextInputViewSpec_cxx& swiftPart = _hybridView->getSwiftPart();
...
- (void) updateProps:(const std::shared_ptr<const react::Props>&)props
  ...
  // 1. Downcast props
  const auto& newViewPropsConst = *std::static_pointer_cast<HybridNitroMultiLineTextInputViewProps const>(props);
  auto& newViewProps = const_cast<HybridNitroMultiLineTextInputViewProps&>(newViewPropsConst);
  NitroTextInput::HybridNitroMultiLineTextInputViewSpec_cxx& swiftPart = _hybridView->getSwiftPart();
  ...
  // onContentSizeChanged: optional
  if (newViewProps.onContentSizeChanged.isDirty) {
    swiftPart.setOnContentSizeChanged(newViewProps.onContentSizeChanged.value);
    newViewProps.onContentSizeChanged.isDirty = false;
  }
