///
/// HybridNitroMultiLineTextInputViewSpec_cxx.swift
...
/**
 * A class implementation that bridges HybridNitroMultiLineTextInputViewSpec over to C++.
 ...
 */
open class HybridNitroMultiLineTextInputViewSpec_cxx {
  /**
  ...
  /**
   * Holds an instance of the `HybridNitroMultiLineTextInputViewSpec` Swift protocol.
   */
  private var __implementation: any HybridNitroMultiLineTextInputViewSpec

  /**
   * Holds a weak pointer to the C++ class that wraps the Swift class.
   */
  private var __cxxPart: bridge.std__weak_ptr_HybridNitroMultiLineTextInputViewSpec_

  /**
   * Create a new `HybridNitroMultiLineTextInputViewSpec_cxx` that wraps the given `HybridNitroMultiLineTextInputViewSpec`.
   * All properties and methods bridge to C++ types.
   */
  public init(_ implementation: any HybridNitroMultiLineTextInputViewSpec) {
  ...
  /**
   * Get the actual `HybridNitroMultiLineTextInputViewSpec` instance this class wraps.
   */
  @inline(__always)
  public func getHybridNitroMultiLineTextInputViewSpec() -> any HybridNitroMultiLineTextInputViewSpec {
  ...
  /**
   * Casts an unsafe pointer to a `HybridNitroMultiLineTextInputViewSpec_cxx`.
   * The pointer has to be a retained opaque `Unmanaged<HybridNitroMultiLineTextInputViewSpec_cxx>`.
   * This removes one strong reference from the object!
   */
  public class func fromUnsafe(_ pointer: UnsafeMutableRawPointer) -> HybridNitroMultiLineTextInputViewSpec_cxx {
    return Unmanaged<HybridNitroMultiLineTextInputViewSpec_cxx>.fromOpaque(pointer).takeRetainedValue()
  }

  /**
   * Gets (or creates) the C++ part of this Hybrid Object.
   * The C++ part is a `std::shared_ptr<HybridNitroMultiLineTextInputViewSpec>`.
   */
  public func getCxxPart() -> bridge.std__shared_ptr_HybridNitroMultiLineTextInputViewSpec_ {
    let cachedCxxPart = self.__cxxPart.lock()
    if cachedCxxPart.__convertToBool() {
      return cachedCxxPart
    } else {
      let newCxxPart = bridge.create_std__shared_ptr_HybridNitroMultiLineTextInputViewSpec_(self.toUnsafe())
      __cxxPart = bridge.weakify_std__shared_ptr_HybridNitroMultiLineTextInputViewSpec_(newCxxPart)
      return newCxxPart
    }
  }
  ...
  public final var scrollEnabled: bridge.std__optional_bool_ {
    ...
    @inline(__always)
    set {
      self.__implementation.scrollEnabled = newValue.value
    }
  }
  ...
  public final var onContentSizeChanged: bridge.std__optional_std__function_void_double____width_____double____height______ {
    @inline(__always)
    get {
      return { () -> bridge.std__optional_std__function_void_double____width_____double____height______ in
        if let __unwrappedValue = self.__implementation.onContentSizeChanged {
    ...
    @inline(__always)
    set {
      self.__implementation.onContentSizeChanged = { () -> ((_ width: Double, _ height: Double) -> Void)? in
