...
/**
 * Represents the JavaScript callback `(height: number) => void`.
...
fun interface Func_void_double: (Double) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(height: Double): Unit
}
...
class Func_void_double_cxx: Func_void_double {
  ...
  @FastNative
  private external fun invoke_cxx(height: Double): Unit
}
