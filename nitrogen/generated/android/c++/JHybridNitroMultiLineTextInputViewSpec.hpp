///
/// HybridNitroMultiLineTextInputViewSpec.hpp
...
namespace margelo::nitro::nitrotextinput {
  ...
  class JHybridNitroMultiLineTextInputViewSpec: public jni::HybridClass<JHybridNitroMultiLineTextInputViewSpec, JHybridObject>,
                                                public virtual HybridNitroMultiLineTextInputViewSpec {
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrotextinput/HybridNitroMultiLineTextInputViewSpec;";
    static jni::local_ref<jhybriddata> initHybrid(jni::alias_ref<jhybridobject> jThis);
    static void registerNatives();

  protected:
    // C++ constructor (called from Java via `initHybrid()`)
    explicit JHybridNitroMultiLineTextInputViewSpec(jni::alias_ref<jhybridobject> jThis) :
      HybridObject(HybridNitroMultiLineTextInputViewSpec::TAG),
      HybridBase(jThis),
      _javaPart(jni::make_global(jThis)) {}

  public:
    ~JHybridNitroMultiLineTextInputViewSpec() override {
  ...
  public:
    inline const jni::global_ref<JHybridNitroMultiLineTextInputViewSpec::javaobject>& getJavaPart() const noexcept {
      return _javaPart;
    }
  ...
  public:
    ...
    std::optional<std::function<void(double /* width */, double /* height */)>> getOnContentSizeChanged() override;
    void setOnContentSizeChanged(const std::optional<std::function<void(double /* width */, double /* height */)>>& onContentSizeChanged) override;
  ...
  private:
    ...
    jni::global_ref<JHybridNitroMultiLineTextInputViewSpec::javaobject> _javaPart;
  };
