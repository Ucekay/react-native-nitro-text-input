...
namespace margelo::nitro::nitrotextinput {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrotextinput/TextAlign;";
  ...
  public:
    ...
    static jni::alias_ref<JTextAlign> fromCpp(TextAlign value) {
      ...
      static const auto fieldNATURAL = clazz->getStaticField<JTextAlign>("NATURAL");
      ...
      switch (value) {
        ...
        case TextAlign::NATURAL:
          return clazz->getStaticFieldValue(fieldNATURAL);
        default:
