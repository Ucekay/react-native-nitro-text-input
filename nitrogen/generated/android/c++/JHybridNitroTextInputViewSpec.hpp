...
namespace margelo::nitro::nitrotextinput {
  ...
  public:
    ...
    std::optional<double> getHeight() override;
    void setHeight(std::optional<double> height) override;
    std::optional<double> getMinWidth() override;
    void setMinWidth(std::optional<double> minWidth) override;
    std::optional<double> getMaxWidth() override;
    void setMaxWidth(std::optional<double> maxWidth) override;
    std::optional<double> getMinHeight() override;
    void setMinHeight(std::optional<double> minHeight) override;
    std::optional<double> getMaxHeight() override;
    void setMaxHeight(std::optional<double> maxHeight) override;
    std::optional<double> getMargin() override;
    void setMargin(std::optional<double> margin) override;
    std::optional<double> getMarginTop() override;
    void setMarginTop(std::optional<double> marginTop) override;
    std::optional<double> getMarginRight() override;
    void setMarginRight(std::optional<double> marginRight) override;
    std::optional<double> getMarginBottom() override;
    void setMarginBottom(std::optional<double> marginBottom) override;
    std::optional<double> getMarginLeft() override;
    void setMarginLeft(std::optional<double> marginLeft) override;
    ...
    std::optional<Position> getPosition() override;
    void setPosition(std::optional<Position> position) override;
    std::optional<double> getTop() override;
    void setTop(std::optional<double> top) override;
    std::optional<double> getRight() override;
    void setRight(std::optional<double> right) override;
    std::optional<double> getBottom() override;
    void setBottom(std::optional<double> bottom) override;
    std::optional<double> getLeft() override;
    void setLeft(std::optional<double> left) override;
