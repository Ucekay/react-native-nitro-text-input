///
/// JHybridNitroMultiLineTextInputViewStateUpdater.cpp
/// This file was generated by nitrogen. DO NOT MODIFY THIS FILE.
/// https://github.com/mrousavy/nitro
/// Copyright © 2025 Marc Rousavy @ Margelo
///

#include "JHybridNitroMultiLineTextInputViewStateUpdater.hpp"
...
using ConcreteStateData = react::ConcreteState<HybridNitroMultiLineTextInputViewState>;

void JHybridNitroMultiLineTextInputViewStateUpdater::updateViewProps(jni::alias_ref<jni::JClass> /* class */,
                                           jni::alias_ref<JHybridNitroMultiLineTextInputViewSpec::javaobject> javaView,
                                           jni::alias_ref<JStateWrapper::javaobject> stateWrapperInterface) {
  JHybridNitroMultiLineTextInputViewSpec* view = javaView->cthis();
  ...
  const HybridNitroMultiLineTextInputViewState& data = concreteState->getData();
  const std::optional<HybridNitroMultiLineTextInputViewProps>& maybeProps = data.getProps();
  if (!maybeProps.has_value()) {
    // Props aren't set yet!
    throw std::runtime_error("HybridNitroMultiLineTextInputViewState's data doesn't contain any props!");
  }
  const HybridNitroMultiLineTextInputViewProps& props = maybeProps.value();
  ...
  if (props.onContentSizeChanged.isDirty) {
    view->setOnContentSizeChanged(props.onContentSizeChanged.value);
    // TODO: Set isDirty = false
  }
  ...
  if (props.hybridRef.isDirty) {
    ...
    if (maybeFunc.has_value()) {
      std::shared_ptr<JHybridNitroMultiLineTextInputViewSpec> shared = javaView->cthis()->shared_cast<JHybridNitroMultiLineTextInputViewSpec>();
